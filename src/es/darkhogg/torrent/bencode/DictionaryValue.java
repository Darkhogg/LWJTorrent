...
public final class DictionaryValue extends Value<Map<String,Value<?>>> {
    ...
    /**
     * Adds a new key-value pair to this dictionary. If the <tt>key</tt> already exists in this dictionary, its value is
     * replaced.
     * 
     * @param key The key to add or replace
     * @param val The new value for the <tt>key</tt>
    ...
    /**
     * Removes the given <tt>key</tt> and its associated value from this dictionary.
     * 
    ...
    /**
     * Returns the value for the given <tt>key</tt>, or <tt>nulll</tt> if the key doesn't exist.
     * 
     * @param key Key which value is to be returned
     * @return The value associated with the <tt>key</tt>, or <tt>null</tt> if the key is not present

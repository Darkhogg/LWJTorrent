...
/**
 * Wraps the bencoded string value as an array of bytes. This object represents bencoded string as bytes to simplify
 * handling of binary data. The <tt>getStringValue</tt> method can retrieve a string created converting the value using
 * <tt>UTF-8</tt>.
 * 
 * @author Daniel Escoz
 * @version 1.0.0
...
public final class StringValue extends Value<byte[]> {
    ...
    /**
     * Returns this objects value as a string. The bytes are interpreted as an UTF-8 encoded string.
     * 

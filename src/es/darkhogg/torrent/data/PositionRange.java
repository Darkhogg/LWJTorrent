...
/**
 * Represents a range of positions within a file, a buffer, or some other linear structure.
 * <p>
 * This class is not general purpose, and should not be used outside this library unless required by some return or
...
public final class PositionRange {
    ...
    /**
     * Constructs a new range where the included positions are all <tt>x</tt> so that <tt>lower <= x < upper</tt>
     * 
    ...
    /**
     * Gets the length of this range. This value is the result of <tt>upper - lower</tt>, where <tt>upper</tt> and
     * <tt>lower</tt> are the upper and lower bounds, respectively, returned by {@link #getUpper} and {@link #getLower}.
     * 

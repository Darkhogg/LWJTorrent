...
/**
 * A class capable of comparing <tt>NodeId</tt> objects to determine their relative <i>distance</i> to another one.
 * 
 * @author Daniel Escoz
 * @version 1.0
 */
public abstract class DistanceMetric {
    ...
    /**
     * Returns the distance between the passed nodes as a <tt>BigInteger</tt> object.
     * <p>
    ...
    /**
     * Returns a <tt>DistanceMetric</tt> that calculates distances by XORing the node IDs and interpreting the result as
     * an unsigned integer.
     * 

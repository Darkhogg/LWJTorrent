...
/**
 * A class that can convert {@link Message}s to {@link Value}s and vice-versa. TODO Implement this whole class.
 * 
 * @author Daniel Escoz
 * @version 1.0
 */
public final class KrpcBencodeConverter {
    ...
    /**
     * Converts the passed bencoded <tt>Value</tt> to a <tt>Message</tt> that represents it.
     * 
     * @param value Value to convert
     * @return Message converted from <tt>value</tt>
     * @throw IllegalArgumentException if the given <tt>value</tt> is not a valid KRPC message representation
     */
    ...
    /**
     * Converts the passed <tt>Message</tt> to a bencoded <tt>Value</tt> that represents it.
     * 

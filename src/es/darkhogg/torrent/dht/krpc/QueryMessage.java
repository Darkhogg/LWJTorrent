...
public final class QueryMessage extends Message {
    ...
    /**
     * Returns a copy of the dictionary that holds all the named arguments. Use this method only if you need the full
     * dictionary. To get individual arguments by name, use {@link #getArgument(String)} or

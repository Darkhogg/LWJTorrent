...
public final class ResponseMessage extends Message {
    ...
    /**
     * Constructs a <tt>ResponseMessage</tt> with the given transaction ID and return values. The <tt>returnValues</tt>
     * argument is deeply copied to guarantee this object immutability.
     * 
     * @param transaction Transaction ID for this message
     * @param returnValues Named return values of the response
    ...
    /**
     * Returns a copy of the dictionary that holds all the named return values. Use this method only if you need the
     * full dictionary. To get individual values by key, use {@link #getReturnValue(String)} or
    ...
    /**
     * Returns a copy of the value associated with the passed <tt>key</tt>, or <tt>null</tt> if it doesn't exist.
     * 
     * @param key The key which value is to be returned
     * @return The value associated with the <tt>key</tt>, or <tt>null</tt> if the key doesn't exist
     */
    ...
    /**
     * Returns a copy of the value associated with the passed <tt>key</tt>, or <tt>null</tt> if it doesn't exist or is
     * of the wrong type.
     * 
     * @param key The key which value is to be returned
     * @param type The type of the returned value
     * @return The value associated with the <tt>key</tt>, or <tt>null</tt> if the key doesn't exist or is of the wrong
     *         type
     */

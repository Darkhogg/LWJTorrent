...
/**
 * Represents a request to a {@link Tracker}. This class is immutable, so it can be reused.
 * <p>
 * Note that the only public way to instantiate this class is using the {@link #builder} method, which returns a
 * {@link TrackerRequest.Builder} object. See its documentation for more information.
 * 
 * @author Daniel Escoz
 * @version 1.0
...
public final class TrackerRequest {
     ...
     * @throws NullPointerException if <tt>infoHash</tt>, <tt>peerId</tt> or <tt>event</tt> are <tt>null</tt>
     * @throws IllegalArgumentException if <tt>port</tt> is not in the range 0-65535 or any of <tt>uploaded</tt>,
     *             <tt>downloaded</tt> or <tt>left</tt> is less than 0.
     */
    ...
    /**
     * @return whether this request is compact or not, or <tt>null</tt> if it doesn't matter
     */
    ...
    /**
     * @return <tt>false</tt> if this request is a no-peer-id, <tt>true</tt> otherwise
     */
    ...
    /**
     * Creates a new {@link TrackerRequest.Builder} object with the default values and returns it.
     * 
     ...
     * <p>
     * To create an object of this class, use the {@link TrackerRequest#builder} method. After that, you can call
     * methods in this class to set the values and then construct the <tt>TrackerRequest</tt> object using the
     * {@link #build} method.
     * <p>
     * This class is implemented using a fluent interface. Every method, except for the final <tt>build</tt>, returns
     * the caller object, so you can chain statements:
     * 
     * <pre>
     * // These simple lines of code...
     * TrackerRequest tr = TrackerRequest.builder().infoHash(h).numWant(33).compact(true).build();
     * 
     ...
     * </pre>
     * <p>
     * This class provides no means to know the state of values and it doesn't check or copy them at all. When calling
     * the <tt>build</tt> method, the constructor from <tt>TrackerRequest</tt> takes care of all. A single builder
     * object may be reused to build multiple requests that share information.
     * 
     * @author Daniel Escoz
     * @version 1.0
     */
    public static class Builder {
         ...
         * <p>
         * If this method is never called, the info hash is <tt>null</tt> by default.
         * 
         ...
         * <p>
         * Note that the passed array is not copied, but stored as is, so changes in the original array will produce
         * changes on this builder.
         * <p>
         * If this method is never called, the peer ID is <tt>null</tt> by default.
         * 
        ...
        /**
         * Stores the given integer as the port told to the tracker to use for incoming peer connections.
         * <p>
        ...
        /**
         * Stores the given long as the total number of bytes uploaded by this client.
         * <p>
        ...
        /**
         * Stores the given long as the total number of bytes downloaded by this client.
         * <p>
        ...
        /**
         * Stores the given long as the total number of bytes this client needs to download to complete the torrent
         * <p>
        ...
        /**
         * Stores the given <tt>Boolean</tt> object as the compactness of the request. Setting this to <tt>null</tt>
         * makes the tracker choose its preferred format.
         * <p>
        ...
        /**
         * Stores the given boolean as whether this builder wants the peer ID of the returned peers or not.
         * <p>
         * If this method is never called, this setting is <tt>false</tt> by default.
         * 
         ...
         * <p>
         * If this method is never called, the event is <tt>REGULAR</tt> by default.
         * 
         ...
         * <p>
         * If this method is never called, the real IP is <tt>null</tt>, which means it is not specified.
         * 
        ...
        /**
         * Stores the passed integer as the number of peers the tracker is supposed to return.
         * <p>
         * If this method is never called, the wanted number of peers is 32 by default.
         * 
         ...
         * <p>
         * If this method is never called, the client key is the value of <tt>Integer.MIN_VALUE</tt>
         * 
         ...
         * changes on this builder.
         * <p>
         * If this method is never called, the tracker ID is <tt>null</tt> by default, meaning it's not specified.
         * 
        ...
        /**
         * Builds a new {@link TrackerRequest} object using the values stored within this builder as its fields.
         * <p>
         * When this method is called, some checks and conversions happen:
         * <ul>
         * <li>If any of <tt>infoHash</tt>, <tt>peerId</tt> or <tt>event</tt> are <tt>null</tt>, a
         * <tt>NullPointerException</tt> is thrown.
         * <li>If the <tt>port</tt> is not in the range 0-65535, an <tt>IllegalArgumentException</tt> is thrown.
         * <li>If <tt>bytesUploaded</tt>, <tt>bytesDownloaded</tt> or <tt>bytesLeft</tt> is less than 0, an
         * <tt>IllegalArgumentException</tt> is thrown.
         * <li>The stored <tt>peerId</tt> and <tt>trackerId</tt> fields are copied, so the returned object doesn't share
         * any references.
         * </ul>
         * 
         * @return A new <tt>TrackerRequest</tt> with the parameters stored within this builder
         */
        public TrackerRequest build () {
            return new TrackerRequest(
                infoHash, peerId, port, uploaded, downloaded, left, compact, noPeerId, event, ip, numWant, key,
                trackerId);
        }
    }
    ...
    public static enum Event {
        ...
        /**
         * Returns the string that must be sent to the tracker. This method returns <tt>""</tt> if no <i>event</i>

...
public final class TrackerResponse {
	...
	/**
	 * Returns the list of peers returned by the tracker. If the request failed,
	 ...
	 * 
	 * @param value
	 *            Bencoded value containing a peer list

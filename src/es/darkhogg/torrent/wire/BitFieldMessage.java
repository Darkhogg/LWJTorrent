...
public final class BitFieldMessage extends BitTorrentMessage {
    ...
    /**
     * Creates a <i>BitField</i> message using the given {@link BitSet} as its bit field.
     * <p>
     * The bit set passed is copied so further modifications does not affect this object.
     * 
     ...
     * <p>
     * The returned is copied so further modifications does not affect this object.
     * 

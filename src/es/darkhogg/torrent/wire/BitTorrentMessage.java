...
public abstract class BitTorrentMessage {
    ...
    /**
     * Returns the type of this message. This method should be used to determine which message arrived, and <b>not</b>
     * the <tt>instanceof</tt> operator, as certain messages may share the same subclass due to payload similarities.
     * 

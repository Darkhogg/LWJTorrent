...
public final class PeerSessionPool implements Closeable {
     ...
     * a message, sends a message or is closed. The passed <tt>listener</tt> will be added to all current and future
     * sessions managed by this pool.
     * 
     * @param listener Listener to add to this pool
     */
     ...
     * sessions managed by this pool, and won't be added to new sessions.
     * 
     * @param listener Listener to remove to this pool
     */
     ...
     * 
     * @param connection Connection to use for the session

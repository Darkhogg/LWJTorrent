...
/**
 * Represents a <i>Piece</i> used by the BitTorrent protocol to send a whole block, that is, a subsection of an actual
 * piece.
 * 
 * @author Daniel Escoz
 * @version 1.0
...
public final class PieceMessage extends BitTorrentMessage {
    ...
    /**
     * Creates a <i>Piece</i> message with the given index, offset and buffer.
     * <p>
     * The passed buffer will be copied into a new buffer. The new buffer will contain only the remaining contents of
     * the original buffer.
     * 
    ...
    /**
     * Creates a <i>Piece</i> message with the given index, offset, buffer and length.
     * <p>
     * The passed buffer will be copied into a new buffer. The new buffer will contain only the first <tt>length</tt>
     * bytes of the remaining contents of the original buffer.
     * 
     * @param index Index of the piece
     * @param offset Offset of the block within the piece
     * @param buf Contents of the block
    ...
    /**
     * Returns the contents of the block stored in this message. The returned buffer is a read-only duplicate of the one
